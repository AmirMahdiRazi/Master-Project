...
class BodyCreateCourse extends StatefulWidget {
  const BodyCreateCourse({super.key});

  @override
  State<BodyCreateCourse> createState() => _BodyCreateCourseState();
}

class _BodyCreateCourseState extends State<BodyCreateCourse> with WindowListener {
